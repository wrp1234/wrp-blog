    ...
    <div class="article clearfix">
      ...
      >
            ...
            <div class="info">
              ...
              <div class="meta">
                ...
                <span class="views-count">
                  阅读 {{state.articleDetail.views}}
                </span>
                <span class="comments-count">
                  评论 {{state.articleDetail.comments}}
                </span>
        ...
        <CommentList
          ...
          :numbers="state.articleDetail.comments"
          :list="state.articleDetail.commentList"
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleSearch = async (): Promise<void> => {
      ...
      const data: any = await service.get(`${urls.getArticleDetail}?id=${state.params.id}`);
